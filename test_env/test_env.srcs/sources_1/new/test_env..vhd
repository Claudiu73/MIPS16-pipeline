...
signal funcIdEx, rtIdEx, rdIdEx, ALUOpIdEx: std_logic_vector(2 downto 0);
...
begin
    ...
    inst_ID: Decode port map(clk, en, Instruction(12 downto 0), WD, RegWriteMemWb, RegDst, ExtOp, RD1, RD2, Ext_imm, func, sa);
    inst_MC: MainControl port map(Instruction(15 downto 13), RegDst, ExtOp, ALUSrc, Branch, Jump, ALUOp, MemWrite, MemtoReg, RegWrite);
    inst_EX: ExecutionUnit port map(PCincIdEx, RD1IdEx, RD2IdEx, Ext_immIdEx, funcIdEx, saIdEx, ALUSrcIdEx, ALUOp, BranchAddress, ALURes, Zero); 
